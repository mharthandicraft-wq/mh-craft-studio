...
const CreativeChallenges = () => {
  ...
  return (
    <section ref={containerRef} className="relative bg-brand-dark overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10 py-32">
          ...
          <div className="lg:col-span-7 space-y-8">
            {challenges.map((item) => (
              <motion.div 
                ...
                */
                className="group relative border border-white/10 bg-brand-dark/60 backdrop-blur-md p-8 transition-all duration-500 hover:border-brand-gold/30 rounded-lg"
              >
