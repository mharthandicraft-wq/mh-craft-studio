      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10 py-32 space-y-48">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            ...
            <p className="font-sans text-neutral-400 text-lg leading-relaxed max-w-md">
          ...
          <div className="lg:col-span-7 space-y-8">
            {challenges.map((item) => (
              <motion.div 
                ...
                className="group relative border border-white/10 bg-brand-dark/60 backdrop-blur-md p-8 rounded-lg"
              >
                <div className="flex items-start gap-6">
                  <div className="mt-2 w-2 h-2 bg-brand-gold rotate-45 shrink-0 group-hover:rotate-90 transition-all duration-500"></div>
                  <div>
                    <h3 className="font-serif text-2xl text-white mb-3 group-hover:text-brand-gold transition-colors">
                      {item.title}
                    </h3>
                    <p className="font-sans text-neutral-300 leading-relaxed text-base md:text-lg">
                      {item.desc}
                    </p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start  pt-32">
            ...
            <div className="space-y-4">
              {statusPoints.map((point, index) => (
                <motion.div 
                  ...
                  className="p-6 bg-brand-dark/60 backdrop-blur-md border border-white/10 flex items-start gap-4 rounded-sm"
                >
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 lg:sticky lg:top-32 text-start lg:text-start">
            ...
            <p className="font-sans text-neutral-400 text-lg leading-relaxed lg:ml-auto max-w-md">
